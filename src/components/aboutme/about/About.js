          ...
          <Col md={7}>
            <Fade duration={3000}>
              <p className="home-about-body">
                My name is <b className="purple">T Dharani Dharan  </b> 
                  and I am a <b className="purple">Computer Science and Engineering </b> 
                    student at <b className="purple">Dhanalakshmi Srinivasan College of Enignieering </b>
                ...
                I also have experience working with frameworks and libraries such as &nbsp;
                  ...
                  <b className="purple">
                    {" "}
                    NodeJS, ReactJS, NodeJS, ExpressJS, MongoDB and JQuery.{" "}
                  </b>
                <br />
                <br />
